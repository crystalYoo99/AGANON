    ...
    <List className={classes.root5}>
      ...
      <div className={classes.section5}>
        ...
        <FormGroup row className={classes.checks}>
          ...
          <FormControlLabel control={<Checkbox name="checkedC" />} label="internet users" />
          <FormControlLabel control={<Checkbox name="checkedD" />} label="mobile subscribers" />
          <FormControlLabel control={<Checkbox name="checkedE" />} label="main telephone lines" />
        </FormGroup>
      </div>
    </List>
