        ...
        <List className={classes.root5}>
          <div className={classes.section5}>
            ...
            <FormGroup row className={classes.checks}>
              ...
              />
              <FormControlLabel
                control={<Checkbox name="checked22" />}
                label="Population"
              />
              <FormControlLabel
                control={<Checkbox name="checked23" />}
                label="Religious_ratio"
              />
              <FormControlLabel
                control={<Checkbox name="checked24" />}
                label="Symptom"
              />
            </FormGroup>
          </div>
