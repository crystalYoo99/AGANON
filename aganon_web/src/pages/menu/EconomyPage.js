...
export default function EconomyPage() {
  const [eco, setEconomy] = React.useState([]);
        ...
        <List className={classes.root5}>
          ...
          <div className={classes.section5}>
            ...
            <FormGroup row className={classes.checks}>
              ...
              <FormControlLabel control={<Checkbox name="gdp_rank_world" />} label="GDP Rank" onChange={handleChange2} />
            </FormGroup>
          </div>
        </List>
            ...
            <Table className={classes.table} aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="left">{state.year || state.gdp || state.gdp_rank_world ? 'Nation Name' : ''}&nbsp;</TableCell>
                  <TableCell align="left">{state.year ? 'Year' : ''}</TableCell>
                  <TableCell align="left">{state.gdp ? 'GDP' : ''}</TableCell>
                  <TableCell align="left">{state.gdp_rank_world ? 'GDP Rank' : ''}</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {eco.map((info) => (
                ...
                {info.name}
                    ...
                    <TableCell align="left">{state.year || state.gdp || state.gdp_rank_world ? info.nation_name : ''}</TableCell>
                    <TableCell align="left">{state.year ? info.year : ''}</TableCell>
                    <TableCell align="left">{state.gdp ? info.gdp : ''}</TableCell>
                    <TableCell align="left">{state.gdp_rank_world ? info.gdp_rank_world : ''}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
