          ...
          <List className={classes.root5}>
            ...
            <div className={classes.section5}>
              ...
              <FormGroup row className={classes.checks}>
                ...
                />
                <FormControlLabel
                  control={<Checkbox name="gdp" />}
                  label="GDP"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="gdp_rank_world" />}
                  label="GDP Rank"
                  onChange={handleChange2}
                />
              </FormGroup>
            ...
            <TableContainer component={Paper}>
              <Table className={classes.table} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="left">
                      {state.year || state.gdp || state.gdp_rank_world
                        ? "Nation Name"
                        : ""}
                      &nbsp;
                    </TableCell>
                ...
                {info.name}
                      ...
                      <TableCell align="left">
                        {state.gdp_rank_world ? info.gdp_rank_world : ""}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
