...
export default function Emergency_InfoPage() {
  ...
  const [state, setState] = React.useState({
    info_id: false,
    embassy: false,
    emergency_medical_service: false,
    police: false,
    fire_station: false,
    checked1: false,
    checked2: false,
        ...
        <div className={classes.baseCase}>
          <List className={classes.root5}>
            ...
            <div className={classes.section5}>
              ...
              <FormGroup row className={classes.checks}>
                <FormControlLabel
                  control={<Checkbox name="embassy" />}
                  label="Embassy"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="emergency_medical_service" />}
                  label="Emergency Medical Service"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="police" />}
                  label="Police"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="fire_station" />}
                  label="Fire Station"
                  onChange={handleChange2}
                />
              </FormGroup>
            ...
            <TableContainer component={Paper}>
              <Table className={classes.table} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="left">
                      {state.embassy ||
                      state.emergency_medical_service ||
                      state.police ||
                      state.fire_station
                        ? "Nation Name"
                        : ""}
                    ...
                    <TableCell align="left">
                      {state.fire_station ? "Fire Station" : ""}
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                ...
                {info.name}
                      ...
                      <TableCell align="left">
                        {state.embassy ? info.embassy : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.emergency_medical_service
                          ? info.emergency_medical_service
                          : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.police ? info.police : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.fire_station ? info.fire_station : ""}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
