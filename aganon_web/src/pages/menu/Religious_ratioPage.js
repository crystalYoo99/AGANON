        ...
        <div className={classes.baseCase}>
          <List className={classes.root5}>
            ...
            <div className={classes.section5}>
              ...
              <FormGroup row className={classes.checks}>
                <FormControlLabel
                  control={<Checkbox name="christianity" />}
                  label="Christianity"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="islam" />}
                  label="Islam"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="etc" />}
                  label="Etc"
                  onChange={handleChange2}
                />
              </FormGroup>
                ...
                <TableHead>
                  <TableRow>
                    <TableCell align="left">
                      {state.christianity || state.islam || state.etc
                        ? "Nation Name"
                        : ""}
                    </TableCell>
                    <TableCell align="left">
                      {state.christianity ? "Christianity" : ""}
                    </TableCell>
                    <TableCell align="left">
                      {state.islam ? "Islam" : ""}
                    </TableCell>
                ...
                <TableBody>
                  {ratio.map(info => (
                    <TableRow key={info.name}>
                      ...
                      <TableCell align="left">
                        {state.christianity ? info.christianity : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.islam ? info.islam : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.etc ? info.etc : ""}
                      </TableCell>
