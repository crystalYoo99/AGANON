      ...
      <div>
        ...
        <List className={classes.root5}>
          ...
          <div className={classes.section5}>
            ...
            <FormGroup row className={classes.checks}>
              <FormControlLabel control={<Checkbox name="contact" />} label="contact" onChange={handleChange2} />
              <FormControlLabel control={<Checkbox name="nation_name" />} label="nation name" onChange={handleChange2} />
            </FormGroup>
          </div>
        </List>
