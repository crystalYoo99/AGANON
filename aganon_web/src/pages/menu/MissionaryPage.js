        ...
        <div className={classes.baseCase}>
          <List className={classes.root5}>
            ...
            <div className={classes.section5}>
              ...
              <FormGroup row className={classes.checks}>
                <FormControlLabel
                  control={<Checkbox name="city_name" />}
                  label="City"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="name_en" />}
                  label="Eng Name"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="contact_info" />}
                  label="Contact Info."
                  onChange={handleChange2}
                />
              </FormGroup>
                ...
                <TableHead>
                  <TableRow>
                    <TableCell align="left">
                      {state.name_en || state.contact_info || state.city_name
                        ? "Nation Name"
                        : ""}
                    </TableCell>
                    <TableCell align="left">
                    ...
                    <TableCell align="left">
                      {state.name_en ? "Eng Name" : ""}
                    </TableCell>
                    <TableCell align="left">
                      {state.contact_info ? "Contact Info." : ""}
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {missionary.map(info => (
                    <TableRow key={info.name}>
                      ...
                      <TableCell align="left">
                        {state.city_name ? info.city_name : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.name_en ? info.name_en : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.contact_info ? info.contact_info : ""}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
