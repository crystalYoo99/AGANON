...
export default function GorvtypePage() {
            ...
            <TableContainer component={Paper}>
              <Table className={classes.table} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    <TableCell align="left">
                      {state.gorv_type_name || state.description
                        ? "Nation Name"
                        : ""}
                      &nbsp;
                    </TableCell>
                    <TableCell align="left">
                      {state.gorv_type_name ? "Gorverment Type" : ""}
                    </TableCell>
                    <TableCell align="left">
                ...
                {info.name}
                      ...
                      <TableCell align="left">
                        {state.gorv_type_name ? info.gorv_type_name : ""}
                      </TableCell>
                      <TableCell align="left">
