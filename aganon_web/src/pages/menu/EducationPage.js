          ...
          <List className={classes.root5}>
            ...
            <div className={classes.section5}>
              ...
              <FormGroup row className={classes.checks}>
                ...
                />
                <FormControlLabel
                  control={<Checkbox name="Children_outSchool" />}
                  label="# of Children OutSchool(Person)"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="Secondary_outSchool" />}
                  label="# of Secondary OutSchool(Person)"
                  onChange={handleChange2}
                />
              </FormGroup>
            </div>
            ...
            <TableContainer component={Paper}>
              <Table className={classes.table} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="left">
                      {state.year ||
                      state.Children_outSchool ||
                      state.Secondary_outSchool
                        ? "Nation Name"
                        : ""}
                      &nbsp;
                    </TableCell>
                    ...
                    <TableCell align="left">
                      {state.Children_outSchool
                        ? "# of Children OutSchool(Person)"
                        : ""}
                    </TableCell>
                    <TableCell align="left">
                      {state.Secondary_outSchool
                        ? "# of Secondary OutSchool(Person)"
                        : ""}
                    </TableCell>
                  </TableRow>
                </TableHead>
                ...
                {info.name}
                      ...
                      <TableCell align="left">
                        {state.Children_outSchool
                          ? info.Children_outSchool
                          : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.Secondary_outSchool
                          ? info.Secondary_outSchool
                          : ""}
                      </TableCell>
                    </TableRow>
                  ))}
