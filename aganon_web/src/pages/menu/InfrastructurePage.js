          ...
          <List className={classes.root5}>
            ...
            <div className={classes.section5}>
              ...
              <FormGroup row className={classes.checks}>
                ...
                />
                <FormControlLabel
                  control={<Checkbox name="total_freight" />}
                  label="Total # of Flight"
                  onChange={handleChange2}
                />
                <FormControlLabel
                ...
                />
                <FormControlLabel
                  control={<Checkbox name="total_road" />}
                  label="Total Length Of Road"
                  onChange={handleChange2}
                />
              </FormGroup>
            </div>
              ...
              <Table className={classes.table} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="left">
                      {state.total_freight ? "Total # of Flight" : ""}
                    </TableCell>
                    <TableCell align="left">
                      {state.passengers ? "Passengers" : ""}
                    </TableCell>
                    <TableCell align="left">
                      {state.total_road ? "Total Length Of Road(km)" : ""}
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {infra.map(info => (
                    <TableRow key={info.name}>
                      ...
                      <TableCell align="left">
                        {state.total_freight ? info.total_freight : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.passengers ? info.passengers : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.total_road ? info.total_road : ""}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
