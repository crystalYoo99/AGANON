  ...
  return (
    ...
    <List className={classes.root5}>
      ...
      <div className={classes.section5}>
        ...
        <FormGroup row className={classes.checks}>
          <FormControlLabel control={<Checkbox name="year" />} label="year" 
                onChange={handleChange2}/>
          <FormControlLabel control={<Checkbox name="total_freight" />} label="total flight" 
                onChange={handleChange2}/>
          <FormControlLabel control={<Checkbox name="passengers" />} label="passengers" 
                onChange={handleChange2}/>
          <FormControlLabel control={<Checkbox name="total_road" />} label="total road" 
                onChange={handleChange2}/>
        </FormGroup>
      </div>
    </List>
