        ...
        <div className={classes.baseCase}>
          <List className={classes.root5}>
            ...
            <div className={classes.section5}>
              ...
              <FormGroup row className={classes.checks}>
                <FormControlLabel
                  control={<Checkbox name="disease_name" />}
                  label="Disease Name"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="disease_type" />}
                  label="Disease Type"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="death_rate" />}
                  label="Death Rate"
                  onChange={handleChange2}
                />
                <FormControlLabel
                  control={<Checkbox name="incubation_period" />}
              ...
              <Table className={classes.table} aria-label="simple table">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="left">
                      {state.disease_name ? "Disease Name" : ""}
                    </TableCell>
                    <TableCell align="left">
                      {state.disease_type ? "Disease Type" : ""}
                    </TableCell>
                    <TableCell align="left">
                      {state.death_rate ? "Death Rate" : ""}
                    </TableCell>
                    <TableCell align="left">
                      {state.incubation_period ? "Incubation Period" : ""}
                    </TableCell>
                    <TableCell align="left">
                ...
                {info.name}
                      ...
                      <TableCell align="left">
                        {state.disease_name ? info.disease_name : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.disease_type ? info.disease_type : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.death_rate ? info.death_rate : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.incubation_period ? info.incubation_period : ""}
                      </TableCell>
                      <TableCell align="left">
                        {state.discription ? info.discription : ""}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
