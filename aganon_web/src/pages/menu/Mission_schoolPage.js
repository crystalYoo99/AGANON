...
export default function Mission_schoolPage() {
  ...
  function handleButtonClicked() {
    var data = {};
    var url = "http://localhost:4000/Mission_School/";
    console.log(url);
    const options_post = {
      method: "POST",
      headers: {
                ...
                <TableHead>
                  <TableRow>
                    <TableCell align="left">
                      {state.name || state.city_name || state.foundation_year
                        ? "Nation Name"
                        : ""}
                    </TableCell>
                    <TableCell align="left">
                    ...
                    <TableCell align="left">
                      {state.foundation_year ? "Foundation Year" : ""}
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {mission_schoold.map(info => (
                    <TableRow key={info.name}>
                      ...
                      <TableCell align="left">
                        {state.foundation_year ? info.foundation_year : ""}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
