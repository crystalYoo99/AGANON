...
router.post('/Disease', (req, res) => {
    ...
    req.body.death_rate ? qry.push('death_rate') : '';
...
router.post('/M_Church', (req, res) => {

    var sql = "SELECT `nation_name`, `name` FROM `M_church` INNER JOIN Nation USING(nation_id) "
